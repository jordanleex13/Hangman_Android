...
public class CategoryData {
    ...
    public static final String[] CATEGORY_LIST = {ANIMALS, SCIENCE, SPORTS, PEOPLE, LANDMARKS, POKEMON, COUNTRIES, MOVIES, LITERATURE};
    public static final int NUM_OF_CATEGORIES = 9;
